...
class NativeScalerWithGradNormCount:
    ...
    def __call__(self, loss, optimizer, clip_grad=None, parameters=None, create_graph=False, update_grad=True, backward_loss=True):
        if backward_loss:
...
def save_model(args, epoch, epoch_name, model, model_without_ddp, optimizer, loss_scaler):
